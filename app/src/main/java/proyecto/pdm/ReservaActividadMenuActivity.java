...
public class ReservaActividadMenuActivity extends ListActivity {
    String[] menu={"Insertar Registro", "Eliminar Registro", "Consultar Registro", "Actualizar Registro"};
    String[] activities={"ReservaActividadInsertarActivity", "ReservaActividadEliminarActivity", "ReservaActividadConsultarActivity", "ReservaActividadActualizarActivity"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(!credencialesUsuario.validarPermiso("Menu de ReservaActividad", idUsuario)){
